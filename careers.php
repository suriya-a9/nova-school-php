...
<body class="preloader-visible" data-barba="wrapper">
  ...
  <main class="main-content">
    ...
    <div class="content-wrapper js-content-wrapper">
        ...
        <div class="container">
          <div class="row y-gap-20 justify-between items-center">
            <div class="col-xl-6 col-lg-6">
              <h2 class="text-30 lh-15 text-white">Finding Your Right Career <img src="img/home_new/open-book.png" class="ml-5" alt="image" draggable="false" /></h2>
              <p class="text-white mt-10">Use the list below to bring attention to your product’s key differentiator.</p>
            </div>
            <div class="col-auto">
              <a href="#career_form" class="button -md -white text-dark-1">Apply Now <i class="icon-arrow-top-right text-13 ml-10"></i></a>
            </div>
          </div>
        </div>
      </section>
      
      <section class="layout-pt-lg layout-pb-lg pt-0 pb-40">
        <div class="container">
          <div data-anim-wrap class="row y-gap-30 justify-between items-center pt-0 pb-0">
            <div class="col-xl-8 col-lg-8 order-2 order-lg-1">
              <h2 data-anim-child="slide-up delay-1" class="text-45 lg:text-40 md:text-30 text-dark-1">Life @ <span class="text-purple-1">Nova Education</span></h2>
      ...
      <section class="layout-pt-lg layout-pb-lg bg-light-6 pt-0" id="career_form">
        <div data-anim-wrap class="container">
          <div class="row y-gap-30 pt-20">
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdb8x1eDytNNJdTgpfsjz7mCVFygZmWDhO36vuWJ9Ks2tHFLQ/viewform?embedded=true" class="button-style car j o i n u s t" target="_blank" width="650" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading&#8230;</iframe>
          </div>
        </div>
      </section>
